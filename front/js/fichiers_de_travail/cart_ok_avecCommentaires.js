...
function checkUserChoice(list) {
    for (let userProduct in list) {
        ...
        console.log(list[userProduct]);
    }
}
// Appel de la fonction en lui passant le nom du tableau
checkUserChoice(userProducts);
console.log(userProducts);*/
...
function fillForm() {
    ...
    const validFirstName = function (inputFirstName) {
        ...
        // et si ça corresponds à 'nameRegex'
            ...
            //alors on affiche ce message d'alerte
            return firstNameErrorMsg.innerHTML = 'ok ça va';
        }
    };
    ...
    const validLastName = function (inputLastName) {
        ...
        // et si ça corresponds à 'nameRegex'
            ...
            //alors on affiche ce message d'alerte
            return lastNameErrorMsg.innerHTML = 'ok ça va';
        }
    };
    ...
    const validAddress = function (inputAddress) {
        ...
        // et si ça corresponds à 'addressRegex'
            ...
            //alors on affiche ce message d'alerte
            return addressErrorMsg.innerHTML = 'ok ça va';
        }
    };
    ...
    const validCity = function (inputCity) {
        ...
        // et si ça corresponds à 'cityRegex'
            ...
            //alors on affiche ce message d'alerte
            return cityErrorMsg.innerHTML = 'ok ça va';
        }
    };
    ...
    const validEmail = function (inputEmail) {
        ...
        console.log(mailRegex.test(inputEmail.value));
    };
